...
Rectangle {
    ...
    Flickable {
        ...
        ColumnLayout {
            ...
            width: Math.min(flickable.width - 40, 640)
            spacing: 20
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    Label { text: "Learning"; font.pixelSize: 16; font.bold: true; color: "#4ec9b0" }
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    Label { text: "Adapters"; font.pixelSize: 16; font.bold: true; color: "#4ec9b0" }
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    Label { text: "Lifecycle"; font.pixelSize: 16; font.bold: true; color: "#569cd6" }
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    Label { text: "Profile Portability"; font.pixelSize: 16; font.bold: true; color: "#569cd6" }
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    Label { text: "Memory"; font.pixelSize: 16; font.bold: true; color: "#4ec9b0" }
